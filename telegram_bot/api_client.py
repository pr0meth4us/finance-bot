...
def _make_request(method, url, jwt=None, **kwargs):
    ...
    try:
        ...
        if res.status_code == 403:
            # Assuming 403 implies premium restriction in this context
        ...
        log.error(f"HTTP error: {http_err} - Response: {http_err.response.text}")
        try:
