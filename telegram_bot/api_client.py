...
def login_to_bifrost(user):
    ...
    payload = {
        ...
        "telegram_data": tg_data # Sending the full signed object
    }
...
# ... [Rest of the file remains unchanged: ensure_auth, get_my_profile, etc.] ...
...
def get_detailed_summary(user_id):
    try:
        res = requests.get(f"{BASE_URL}/summary/detailed", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_open_debts(user_id):
    try:
        res = requests.get(f"{BASE_URL}/debts/", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_open_debts_export(user_id):
    try:
        res = requests.get(f"{BASE_URL}/debts/export/open", headers=_get_headers(user_id), timeout=15)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_settled_debts_grouped(user_id):
    try:
        res = requests.get(f"{BASE_URL}/debts/list/settled", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_debts_by_person_and_currency(person_name, currency, user_id):
    try:
        ...
        res = requests.get(f"{BASE_URL}/debts/person/{encoded_name}/{currency}", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
        log.error(f"API Error fetching debts for {person_name} ({currency}): {e}")
        return []
...
def get_all_debts_by_person(person_name, user_id):
    try:
        encoded_name = urllib.parse.quote(person_name)
        res = requests.get(f"{BASE_URL}/debts/person/{encoded_name}/all", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_all_settled_debts_by_person(person_name, user_id):
    try:
        encoded_name = urllib.parse.quote(person_name)
        res = requests.get(f"{BASE_URL}/debts/person/{encoded_name}/all/settled", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
        log.error(f"API Error fetching all settled debts for {person_name}: {e}")
        return []

@ensure_auth
def get_debt_details(debt_id, user_id):
    try:
        res = requests.get(f"{BASE_URL}/debts/{debt_id}", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def cancel_debt(debt_id, user_id):
    try:
        res = requests.post(f"{BASE_URL}/debts/{debt_id}/cancel", json={}, headers=_get_headers(user_id), timeout=15)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def update_debt(debt_id, data, user_id):
    try:
        res = requests.put(f"{BASE_URL}/debts/{debt_id}", json=data, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
@ensure_auth
def record_lump_sum_repayment(person_name, currency, amount, debt_type, user_id, timestamp=None):
    try:
...
def update_exchange_rate(rate, user_id):
    try:
        res = requests.post(f"{BASE_URL}/settings/rate", json={'rate': rate}, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_exchange_rate(user_id):
    try:
        res = requests.get(f"{BASE_URL}/settings/rate", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def add_transaction(data, user_id):
    try:
        res = requests.post(f"{BASE_URL}/transactions/", json=data, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_recent_transactions(user_id):
    try:
        res = requests.get(f"{BASE_URL}/transactions/recent", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_transaction_details(tx_id, user_id):
    try:
        res = requests.get(f"{BASE_URL}/transactions/{tx_id}", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def update_transaction(tx_id, data, user_id):
    try:
        res = requests.put(f"{BASE_URL}/transactions/{tx_id}", json=data, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def delete_transaction(tx_id, user_id):
    try:
        res = requests.delete(f"{BASE_URL}/transactions/{tx_id}", json={}, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return True
    except requests.exceptions.RequestException as e:
...
def search_transactions_for_management(params, user_id):
    try:
        res = requests.post(f"{BASE_URL}/transactions/search", json=params, headers=_get_headers(user_id), timeout=20)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_detailed_report(user_id, start_date=None, end_date=None):
    try:
        ...
        res = requests.get(f"{BASE_URL}/analytics/report/detailed", params=params, headers=_get_headers(user_id), timeout=15)
...
def get_spending_habits(user_id, start_date, end_date):
    try:
        ...
        res = requests.get(f"{BASE_URL}/analytics/habits", params=params, headers=_get_headers(user_id), timeout=20)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_debt_analysis(user_id):
    try:
        res = requests.get(f"{BASE_URL}/debts/analysis", headers=_get_headers(user_id), timeout=15)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def sum_transactions_for_analytics(params, user_id):
    try:
        res = requests.post(f"{BASE_URL}/analytics/search", json=params, headers=_get_headers(user_id), timeout=20)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def get_user_settings(user_id):
    try:
        res = requests.get(f"{BASE_URL}/settings/", headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def update_initial_balance(user_id, currency, amount):
    try:
        ...
        res = requests.post(f"{BASE_URL}/settings/balance", json=payload, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def update_user_mode(user_id, mode, language=None, name_en=None, name_km=None, primary_currency=None):
    try:
        payload = {'mode': mode, 'name_en': name_en}
        if language: payload['language'] = language
        if name_km: payload['name_km'] = name_km
        if primary_currency: payload['primary_currency'] = primary_currency
        res = requests.post(f"{BASE_URL}/settings/mode", json=payload, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def complete_onboarding(user_id):
    try:
        res = requests.post(f"{BASE_URL}/settings/complete_onboarding", json={}, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def add_category(user_id, cat_type, cat_name):
    try:
        ...
        res = requests.post(f"{BASE_URL}/settings/category", json=payload, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
...
def remove_category(user_id, cat_type, cat_name):
    try:
        payload = {'type': cat_type, 'name': cat_name}
        res = requests.delete(f"{BASE_URL}/settings/category", json=payload, headers=_get_headers(user_id), timeout=10)
        res.raise_for_status()
        return res.json()
    except requests.exceptions.RequestException as e:
