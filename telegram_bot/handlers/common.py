...
async def menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    """
    # --- OPTIMIZATION (1.4.0) ---
    # Removed explicit sync_subscription_status() check.
    # We now rely on Bifrost 1.6.0+ Webhooks to invalidate the cache on the backend.
    # The @authenticate_user decorator will automatically fetch the fresh role
    # from the backend if the cache was invalidated.
